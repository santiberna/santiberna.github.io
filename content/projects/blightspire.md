...
Blightspire is a WIP custom engine game for the year long custom tech project I had to do at BUAS. It is a boomer shooter that incorporates fast paced gameplay, pixelized and grainy graphics and a lot of particles! 
...
One of the key aspects of scripting was the runtime reloading of the scripting, since **it made the experience of developing gameplay for the rest of the team much more enjoyable and responsive.**

VIDEO OF EDITING AND PLAYING WITH WREN

The bindings were the part that took the most work. I used the [wrenbind17 library](https://github.com/matusnovak/wrenbind17) for creating wren bindings for C++ since it was much easier and less error prone than the C API.
...
TODO: SHOW MODULE DEPENDENCY GRAPH
...
<div class="row">
  <div style="width: 50%">
    <img src="/images/blightspire/linter.png" alt="Snow" style="width:100%">
  </div>
  <div style="width: 50%">
    <img src="/images/blightspire/build_checks.png" alt="Forest" style="width:100%">
  </div>
</div>
